...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "it_projekt18" because\n';
  ...
  $wnd.__gwt_activeModules['it_projekt18'] = {
    'moduleName' : 'it_projekt18',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/it_projekt18.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['it_projekt18'].superdevmode = true;

  var expectedSuffix = '/it_projekt18.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + it_projekt18 + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:it_projekt18';
  var devModeSessionKey = '__gwtDevModeSession:it_projekt18';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/it_projekt18/it_projekt18.nocache.js';
  ...
  $wnd.__gwt_activeModules['it_projekt18'].canRedirect = true;
  $wnd.__gwt_activeModules['it_projekt18'].superdevmode = true;
  ...
  css = (moduleIdx == 1 ? css : '') +
    ".gwt-DevModeModule-" + moduleIdx + ".gwt-DevModeCompiling div:before{" +
      "content:'COMPILING it_projekt18';" +
      "font-size:24px;" +
      "color:#d2d9ee;" +
    "}";
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/it_projekt18?user.agent=' + ua + '&_callback=' + callback;
