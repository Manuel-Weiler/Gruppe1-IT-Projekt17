...
(function($wnd, $doc){
  ...
  var badBrowser = 'Unable to load Super Dev Mode of "project4u" because\n';
  ...
  $wnd.__gwt_activeModules['project4u'] = {
    'moduleName' : 'project4u',
    'bindings' : function() {
      return {};
    }
  };
 ...
 * "/project4u.nocache.js" is the one that loaded us. Normally this happens
...
function computeScriptBase() {
  ...
  $wnd.__gwt_activeModules['project4u'].superdevmode = true;

  var expectedSuffix = '/project4u.nocache.js';
  ...
  $wnd.alert('Unable to load Super Dev Mode version of ' + project4u + ".");
}
;
  ...
  var devModeHookKey = '__gwtDevModeHook:project4u';
  var devModeSessionKey = '__gwtDevModeSession:project4u';

  // Compute some codeserver urls so as the user does not need bookmarklets
  var hostName = $wnd.location.hostname;
  var serverUrl = 'http://' + hostName + ':9876';
  var nocacheUrl = serverUrl + '/project4u/project4u.nocache.js';
  ...
  $wnd.__gwt_activeModules['project4u'].canRedirect = true;
  $wnd.__gwt_activeModules['project4u'].superdevmode = true;
  ...
  $wnd[compileFunction] = function() {
    ...
    compileScript.src = serverUrl +
      '/recompile/project4u?user.agent=' + ua + '&_callback=' + callback;
