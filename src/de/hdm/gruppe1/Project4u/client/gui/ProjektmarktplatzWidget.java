...
public class ProjektmarktplatzWidget extends Composite {
	...
	// TODO:// Clickhandler und Maske für Projektmarktplatz anlegen 																		// implementieren
	Button deleteProjektmarktplatz = new Button("Projektmarktplatz löschen"); 
	// TODO:
																				// anlegen
	Button seeProjektmarktplatz = new Button("Projektmarktplatz ansehen"); // TODO:
																			// Clickhandler:
																			// mit
																			// ProjektWidget
																			// verknüpfen
	...
	public ProjektmarktplatzWidget(Vector<Projektmarktplatz> projektmarktplaetze) {
		if (projektmarktplaetze.isEmpty()) {
			...
			// Die Spalte der Projektmarktplatz-Tabelle wird erstellt und deren
			// Inhalt definiert.
			...
			/**
			 * Hinzufügen der Spalten zur Tabelle, in der Reihenfolge von Links
			 * nach Rechts. Definition der Spaltennamen.
			 */
			...
			/*
			 * Das SelectionModel wird zur Tabelle der Projektmarktplätze
			 * hinzugefügt und gewährleistet, ähnlich einem ClickHandler, dass
			 * beim Klicken auf eine Tabellenzeile das jeweilige Objekt
			 * zurückgegeben wird.
			 */
			...
			/*
			 * Der durch den SelectionHandler zurückgegebene Projektmarktplatz
			 * kann an eine Instanz des ProjekteWidgets übergeben werden.
			 */
				...
				public void onSelectionChange(SelectionChangeEvent event) {
					...
					seeProjektmarktplatz.addClickHandler(new ClickHandler() {
						...
						public void onClick(ClickEvent event) {
							// TODO: Die Projektmarktplatzinstanz wird an eine
							// Projektinstanz weitergegeben,
					...
					deleteProjektmarktplatz.addClickHandler(new ClickHandler() {
						...
						@Override
						public void onClick(ClickEvent event) {
							// TODO: Löschen des Projektmarktplatzes nach
							// vorangegangener Prüfung, ob
